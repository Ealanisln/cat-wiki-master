  ...
  <div className="flex flex-wrap -mx-2">
    <div className="w-1/2 md:w-1/4 px-2 mb-8">
      <Image
        ...
        height={150}
      />
      <p className="font-semibold text-[#73675c] text-left mt-2">Abyssian Cat</p>
    </div>
    <div className="w-1/2 md:w-1/4 px-2 mb-8">
      <Image
        className="object-cover w-[450px] h-60 rounded-xl shadow-md"
        ...
        height={200}
      />
      <p className="font-semibold text-[#73675c] text-left mt-2">Aegean Cat</p>
    </div>
    <div className="w-1/2 md:w-1/4 px-2 mb-8">
      <Image
        className="object-cover w-[450px] h-60 rounded-xl shadow-md"
        ...
        height={200}
      />
      <p className="font-semibold text-[#73675c] text-left mt-2">American Bobtail Cat</p>
    </div>
    <div className="w-1/2 md:w-1/4 px-2 mb-8">
      <Image
        className="object-cover w-[450px] h-60 rounded-xl shadow-md"
        ...
        height={200}
      />
      <p className="font-semibold text-[#73675c] text-left mt-2">American Curl Cat</p>
    </div>
  </div>
</section>
